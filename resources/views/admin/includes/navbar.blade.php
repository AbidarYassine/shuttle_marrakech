            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    ...
                    <!-- <img class="brand-logo" alt="modern admin logo" src="{{asset('assets/admin/images/logo/logo.png')}}"> -->
                        ...
                        <h3 class="brand-text"><i class="text-warning fa fa-car fa-2x"></i>SuttleMarrakech</h3>
                    </a>
                </li>
            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right"><a href="{{route('admin.profile')}}"
                    ...
                    <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link"
                                ...
                                class="flag-icon flag-icon-fr"></i><span class="selected-language"></span></a>
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                            <a class="dropdown-item" href="#"><i class="flag-icon flag-icon-fr"></i> Francais</a>
                            <a class="dropdown-item" href="#"><i class="flag-icon flag-icon-gb"></i> Anglais</a>
