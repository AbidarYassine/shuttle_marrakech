                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 offset-md-4">
                            <img style="height: 150px; width: 150px;" src="{{$vehicule->image}}" alt="image véhicule">
                        </div>
                    </div>
                    <form action="{{route('admin.vehicule.update',$vehicule->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="matricule" value="{{$vehicule->matricule}}" class="form-control  @error('matricule') is-invalid @enderror">
                                    @error('matricule')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" min="1" name="model" value="{{$vehicule->model}}" class="form-control @error('model') is-invalid @enderror">
                                    @error('model')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="categorie_id" id="categorie_id" class="form-control">
                                        <option value="{{$vehicule->categorie->id}}">{{$vehicule->categorie->designation}}</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" name="nombre_valise" value="{{$vehicule->nombre_valise}}" class="form-control @error('nombre_valise') is-invalid @enderror">
                                    @error('nombre_valise')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="chauffeur_id" value="---" class="form-control @error('chauffeur_id') is-invalid @enderror">
                                        <option value="{{$vehicule->chauffeur->id}}" selected>{{$vehicule->chauffeur->nom." ".$vehicule->chauffeur->prenom}}</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="marque" value="{{$vehicule->marque}}" class="form-control @error('marque') is-invalid @enderror">
                                    @error('marque')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input  type="file" class="form-control @error('image') is-invalid @enderror" placeholder="choisit des images" name="image">
                                @error('image.*')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
