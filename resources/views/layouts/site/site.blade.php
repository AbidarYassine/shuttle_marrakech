...
<head>
   ...
   navite center, ville, aeroport center ville,aeropot vers essaouira,aeropot ssaouira,aeropt rachidia,aeroport de marrakech vers essaouira">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans+Condensed:ital,wght@0,300;0,700;1,300&family=Source+Sans+Pro:ital,wght@0,200;0,300;0,400;0,600;0,900;1,200;1,300;1,400;1,600;1,700&display=swap" rel="stylesheet">
    <style>
        #infoTel {
            margin-top: 6px;
        }
